...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { active_date: @name.active_date, name: @name.name, target_id: @name.target_id, target_type: @name.target_type, user_id: @name.user_id }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { active_date: @name.active_date, name: @name.name, target_id: @name.target_id, target_type: @name.target_type, user_id: @name.user_id }
    assert_redirected_to name_path(assigns(:name))
  end
