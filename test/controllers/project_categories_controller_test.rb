...
class ProjectCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create project_category" do
    assert_difference('ProjectCategory.count') do
      post :create, project_category: { category_type: @project_category.category_type, description: @project_category.description, user_id: @project_category.user_id }
    end
  ...
  test "should update project_category" do
    patch :update, id: @project_category, project_category: { category_type: @project_category.category_type, description: @project_category.description, user_id: @project_category.user_id }
    assert_redirected_to project_category_path(assigns(:project_category))
  end
